...
function spawnObstaclesTop() 
{
      if(World.frameCount % 60 === 0) {
        obstacleTop = createSprite(400,100,40,100);
...
function createObstacle(){
  ...
  switch (rand){
    case 1:obstacle.addImage(obsBottom1);break;
    case 2:obstacle.addImage(obsBottom2);break;
    case 3:obstacle.addImage(obsBottom3);break;
  }
  }
